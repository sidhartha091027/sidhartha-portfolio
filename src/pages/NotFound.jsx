...
function NotFound() {
  return (
    <>
      <Helmet>
        <title>404 - Page Not Found | Sidhartha Kumar Sahoo</title>

        <meta
          name="description"
          content="The page you're looking for doesn't exist or has been moved. Return to Sidhartha Kumar Sahoo's portfolio website."
        />
        ...
        <link
          rel="canonical"
          href="https://sidharthakumarsahoo.com"
        />
      </Helmet>
